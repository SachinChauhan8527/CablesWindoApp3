...
void EdgesSubPix(Mat &gray, double alpha, int low, int high,
    vector<Contour> &contours, OutputArray hierarchy, int mode, vector<vector<Point>> &contours_1)
{
    Mat blur;
...
void EdgesSubPix(Mat &gray, double alpha, int low, int high, vector<Contour> &contours, vector<vector<Point>> &contours_1)
{
    vector<Vec4i> hierarchy;
   
    EdgesSubPix(gray, alpha, low, high, contours, hierarchy, RETR_LIST, contours_1);
}